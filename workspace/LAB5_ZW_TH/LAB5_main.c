...
__interrupt void ADCC_ISR (void)
{
    ...
    if (numADCCcalls < 2000){
       ...
       x =     (((adcc0result - sumx)*3.0 / 4095.0)) * 400.0 / 180.0 * PI;
       x4 =    (((adcc1result - sumx4)*3.0 / 4095.0)) * 100.0 / 180.0 * PI;
       z4 =    (((adcc2result - sumz4)*3.0 / 4095.0)) * 100.0 / 180.0 * PI;
       z =     (((adcc3result - sumz)*3.0 / 4095.0)) * 400.0 / 180.0 * PI;
...
//    init_serialSCID(&SerialD,115200);
    ...
    while(1)
    {
        if (UARTPrint == 1 ) {
			...
			UART_printfLine(2,"z:%.2f z4:%.2f",I_z, I_z4);
            UARTPrint = 0;
        }
    }
}
