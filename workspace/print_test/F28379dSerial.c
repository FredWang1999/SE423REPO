...
__interrupt void RXAINT_recv_ready(void)
{
    ...
    PieCtrlRegs.PIEACK.all = PIEACK_GROUP9;
    // if receive 'a', turn on LED_red
    // if receive 'b', turn off LED_red
    ...
    // if receive '1', turn on/off LED_1
    // if receive '2', turn on/off LED_2
    // if receive '3', turn on/off LED_3
    // if receive '4', turn on/off LED_4
    if (RXAdata == '1'){
